...
import dev.mark.system.render.builder.RectangleBuilder;
import java.util.HashMap;
import java.util.Map;

public class RectangleCache {
    private static final Map<Long, BuiltRectangle> aiy = new HashMap<>(256);
    ...
    public static BuiltRectangle b(float f, float f1, float f2) {
        ...
        BuiltRectangle builtrectangle1 = new RectangleBuilder().a(f, f1).b(f2).a();
