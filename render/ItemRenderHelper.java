...
public final class ItemRenderHelper {
    private static final MinecraftClient of = MinecraftClient.method_1551();
    ...
    public static void a(Matrix4f matrix4f, ItemStack itemstack, float f, float f1, float f2, float f3) {
        if (!(f3 < 0.001F)) {
            DrawContext drawcontext = new DrawContext(of, of.method_22940().method_23000());
            drawcontext.method_51448().method_23760().method_23761().set(matrix4f);
            float f4 = f2 / 16.0F;
            drawcontext.method_51448().method_22903();
            drawcontext.method_51448().method_46416(f, f1, 0.0F);
            drawcontext.method_51448().method_22905(f4, f4, 1.0F);
            if (f3 < 1.0F) {
    ...
    public static void b(Matrix4f matrix4f, float f, float f1, ItemStack itemstack, float f2, float f3, float f4) {
        int i = itemstack.method_7936();
        int j = itemstack.method_7919();
        if (i != 0) {
            float f5 = (float)(i - j) / i;
            float f6 = f5 * f2;
            int k = ColorCache.d(0, 0, 0, f4);
            int l = c(f5, f4);
            Immediate immediate = of.method_22940().method_23001();
            VertexConsumer vertexconsumer = immediate.getBuffer(RenderLayer.method_51784());
    ...
    public static void e(VertexConsumer vertexconsumer, Matrix4f matrix4f, float f, float f1, float f2, float f3, int i) {
        ...
        vertexconsumer.method_22918(matrix4f, f, f1 + f3, 0.0F).method_22915(f5, f6, f7, f4);
        vertexconsumer.method_22918(matrix4f, f + f2, f1 + f3, 0.0F).method_22915(f5, f6, f7, f4);
        vertexconsumer.method_22918(matrix4f, f + f2, f1, 0.0F).method_22915(f5, f6, f7, f4);
        vertexconsumer.method_22918(matrix4f, f, f1, 0.0F).method_22915(f5, f6, f7, f4);
    }
}
