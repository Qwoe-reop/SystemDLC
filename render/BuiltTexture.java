...
public class BuiltTexture implements Renderable {
    private static final ShaderProgramKey apr = ShaderUtil.a("texture", VertexFormats.field_1575, Defines.field_53930);
    ...
    public void render(Matrix4f matrix4f, float f, float f1, float f2) {
        ...
        shaderprogram.method_34582("Size").method_1255(f3, f4);
        shaderprogram.method_34582("Radius").method_35657(this.nj.a(), this.nj.b(), this.nj.c(), this.nj.d());
        shaderprogram.method_34582("Smoothness").method_1251(this.axx);
        BufferBuilder bufferbuilder = Tessellator.method_1348().method_60827(DrawMode.field_27382, VertexFormats.field_1575);
        bufferbuilder.method_22918(matrix4f, f, f1, f2).method_22913(this.Or, this.hT).method_39415(this.aie.a());
        bufferbuilder.method_22918(matrix4f, f, f1 + f4, f2).method_22913(this.Or, this.hT + this.qw).method_39415(this.aie.b());
        bufferbuilder.method_22918(matrix4f, f + f3, f1 + f4, f2).method_22913(this.Or + this.ts, this.hT + this.qw).method_39415(this.aie.c());
        bufferbuilder.method_22918(matrix4f, f + f3, f1, f2).method_22913(this.Or + this.ts, this.hT).method_39415(this.aie.d());
