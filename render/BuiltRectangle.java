...
import dev.mark.system.module.client.CustomThemeModule;
...
public final class BuiltRectangle implements Renderable {
    private static final ShaderProgramKey VQ = ShaderUtil.a("rectangle", VertexFormats.field_1576, Defines.field_53930);
    ...
    private static String EaseBounceOut = "Стандарт";
    ...
    public static void safeSetUniform(ShaderProgram shader, String name, float... values) {
    ...
    private static void g(String s, CustomThemeModule customthememodule) {
        ...
        if (i != tu) {
            long j = i - tu;
            tu = i;
            if (Gr || !s.equals(EaseBounceOut) || s.equals("Кастом")) {
                if (s.equals("Кастом") && customthememodule != null) {
                    ...
                    boolean flag = false;
                    if (arU && EaseBounceOut.equals("Кастом")) {
    ...
    private void h(Matrix4f matrix4f, float f, float f1, float f2, float f3) {
        CustomThemeModule customthememodule = ClientMain.getInstance().getModuleManager().getModule(CustomThemeModule.class);
        if (customthememodule != null && customthememodule.e()) {
            ...
            safeSetUniform(shaderprogram, "Size", this.ati, this.aoi);
            safeSetUniform(shaderprogram, "Offset", f4, f4);
            safeSetUniform(shaderprogram, "CornerRadius", this.qA, this.qA, this.qA, this.qA);
            safeSetUniform(shaderprogram, "BlurRadius", 1.2F);
            safeSetUniform(shaderprogram, "ShadowOffset", -2.0F);
            safeSetUniform(shaderprogram, "ShadowStrength", 0.5F);
            safeSetUniform(shaderprogram, "BorderThickness", 1.0F);
            safeSetUniform(shaderprogram, "BorderSoftness", 0.3F);
            safeSetUniform(shaderprogram, "EdgeSoftness", 0.3F);
            safeSetUniform(shaderprogram, "DitherStrength", 0.003F);
            safeSetUniform(shaderprogram, "Margin", 0.0F);
            safeSetUniform(shaderprogram, "GlobalAlpha", f3);
            String s = "Стандарт";
            if (customthememodule != null) {
                safeSetUniform(shaderprogram, "NoiseStrength", customthememodule.u().getFloatValue());
                safeSetUniform(shaderprogram, "RadialScale", customthememodule.p().getFloatValue(), customthememodule.q().getFloatValue());
                safeSetUniform(shaderprogram, "RadialRadius", customthememodule.r().getFloatValue());
                safeSetUniform(shaderprogram, "RadialCenter", customthememodule.s().getFloatValue(), customthememodule.t().getFloatValue());
            ...
            safeSetUniform(shaderprogram, "GradientColor1", Pc[0], Pc[1], Pc[2], Pc[3]);
            safeSetUniform(shaderprogram, "GradientColor2", asu[0], asu[1], asu[2], asu[3]);
            safeSetUniform(shaderprogram, "GradientColor3", fi[0], fi[1], fi[2], fi[3]);
            safeSetUniform(shaderprogram, "GradientColor4", tK[0], tK[1], tK[2], tK[3]);
            safeSetUniform(shaderprogram, "BorderColor1", akh[0], akh[1], akh[2], akh[3]);
            safeSetUniform(shaderprogram, "BorderColor2", tl[0], tl[1], tl[2], tl[3]);
            safeSetUniform(shaderprogram, "BorderColor3", ap[0], ap[1], ap[2], ap[3]);
            safeSetUniform(shaderprogram, "BorderColor4", Vl[0], Vl[1], Vl[2], Vl[3]);
    ...
    public static void k(
        ...
        float f7 = f3 * 2.0F;
        float f8 = 5.0F;
        safeSetUniform(shaderprogram, "Size", f7, f7);
        safeSetUniform(shaderprogram, "Offset", f8, f8);
        safeSetUniform(shaderprogram, "GlobalAlpha", f5);
        safeSetUniform(shaderprogram, "EdgeSoftness", 1.5F);
        safeSetUniform(shaderprogram, "BorderThickness", 1.0F);
        safeSetUniform(shaderprogram, "BorderSoftness", 0.5F);
        safeSetUniform(shaderprogram, "NoiseStrength", 1.5F);
        safeSetUniform(shaderprogram, "BorderColor1", 0.35F, 0.37F, 0.4F, 0.6F);
        safeSetUniform(shaderprogram, "BorderColor2", 0.2F, 0.2F, 0.2F, 0.3F);
        safeSetUniform(shaderprogram, "BorderColor3", 0.1F, 0.1F, 0.1F, 0.0F);
        safeSetUniform(shaderprogram, "BorderColor4", 0.0F, 0.0F, 0.0F, 0.0F);
        safeSetUniform(shaderprogram, "RingMode", 1.0F);
        safeSetUniform(shaderprogram, "InnerRadius", f2);
        safeSetUniform(shaderprogram, "OuterRadius", f3);
        safeSetUniform(shaderprogram, "SegmentCount", i);
        safeSetUniform(shaderprogram, "GapAngle", 0.03F);
        safeSetUniform(shaderprogram, "RotationOffset", f6);
        safeSetUniform(shaderprogram, "HoverSegment", j);
        safeSetUniform(shaderprogram, "PendingSegment", k);
        safeSetUniform(shaderprogram, "FlashSegment", l);
        safeSetUniform(shaderprogram, "FlashProgress", f4);
        safeSetUniform(shaderprogram, "IsFlashDelete", flag ? 1.0F : 0.0F);
        if (color != null) {
            float f9 = color.getRed() / 255.0F;
            float f10 = color.getGreen() / 255.0F;
            float f11 = color.getBlue() / 255.0F;
            float f12 = color.getAlpha() / 255.0F;
            safeSetUniform(shaderprogram, "RingBaseColor", f9, f10, f11, f12);
        } else {
            safeSetUniform(shaderprogram, "RingBaseColor", 0.8F, 0.8F, 0.8F, 0.37F);
        }
        ...
        if (color1 != null) {
            ...
            safeSetUniform(shaderprogram, "RingHoverColor", f13, f14, f16, f18);
        } else {
            safeSetUniform(shaderprogram, "RingHoverColor", 1.0F, 0.82F, 0.18F, 0.55F);
        }

        safeSetUniform(shaderprogram, "RingPendingColor", 0.39F, 0.78F, 1.0F, 0.55F);
        safeSetUniform(shaderprogram, "RingFlashAddColor", 0.39F, 1.0F, 0.39F, 0.55F);
        safeSetUniform(shaderprogram, "RingFlashDeleteColor", 1.0F, 0.27F, 0.27F, 0.55F);
        BufferBuilder bufferbuilder = Tessellator.method_1348().method_60827(DrawMode.field_27382, VertexFormats.field_1576);
        float f15 = f - f3 - f8;
        float f17 = f1 - f3 - f8;
        float f19 = f7 + f8 * 2.0F;
        int i1 = (int)(f5 * 255.0F) << 24 | 16777215;
        bufferbuilder.method_22918(matrix4f, f15, f17, 0.0F).method_39415(i1);
        bufferbuilder.method_22918(matrix4f, f15, f17 + f19, 0.0F).method_39415(i1);
        bufferbuilder.method_22918(matrix4f, f15 + f19, f17 + f19, 0.0F).method_39415(i1);
        bufferbuilder.method_22918(matrix4f, f15 + f19, f17, 0.0F).method_39415(i1);
        BufferRenderer.method_43433(bufferbuilder.method_60800());
        safeSetUniform(shaderprogram, "RingMode", 0.0F);
        RenderSystem.enableCull();
        RenderSystem.disableBlend();
    }
    ...
    public int hashCode() {
        return Objects.hash(
            this.ati, this.aoi, this.qA, Arrays.hashCode(this.UC), Arrays.hashCode(this.tA), Arrays.hashCode(this.anB), Arrays.hashCode(this.mw)
        );
    }
