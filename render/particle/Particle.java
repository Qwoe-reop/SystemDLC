...
public class Particle {
    ...
    public Particle(double d0, double d1, double d2, double d3, double d4, double d5, float f, float f1, float f2) {
        this(d0, d1, d2, d3, d4, d5, f, f1, f2, 0.97F);
    }

    public Particle(double d0, double d1, double d2, double d3, double d4, double d5, float f, float f1, float f2, float f3) {
        this.oX = d0;
        this.FO = d1;
        this.dO = d2;
        this.aye = d0;
