...
public final class BuiltWhiteRectangle implements Renderable {
    private static final ShaderProgramKey zJ = ShaderUtil.a("white_rectangle", VertexFormats.field_1576, Defines.field_53930);
    ...
    private static final float[] HwidActionData = new float[4];
        ...
        if (i != MX) {
            ...
            if (ah || !s.equals(jb) || s.equals("Кастом")) {
                ...
                if (s.equals("Кастом") && customthememodule != null) {
                    d(customthememodule.h().getColor(), HwidActionData);
                    ...
                    if (amW && jb.equals("Кастом")) {
                        flag = !f(HwidActionData, akM) || !f(ajz, Fm) || !f(akE, wH) || !f(FF, PF);
                    }

                    e(HwidActionData, akM);
                    e(ajz, Fm);
                    e(akE, wH);
                    e(FF, PF);
                    amW = true;
    ...
    private void h(Matrix4f matrix4f, float f, float f1, float f2, float f3) {
        ...
        BuiltRectangle.safeSetUniform(shaderprogram, "Size", this.EI, this.acD);
        BuiltRectangle.safeSetUniform(shaderprogram, "Offset", f4, f4);
        BuiltRectangle.safeSetUniform(shaderprogram, "CornerRadius", this.tn, this.tn, this.tn, this.tn);
        BuiltRectangle.safeSetUniform(shaderprogram, "BlurRadius", this.Oy);
        BuiltRectangle.safeSetUniform(shaderprogram, "ShadowOffset", this.PO);
        BuiltRectangle.safeSetUniform(shaderprogram, "ShadowStrength", this.tS);
        BuiltRectangle.safeSetUniform(shaderprogram, "BorderThickness", 0.3F);
        BuiltRectangle.safeSetUniform(shaderprogram, "BorderSoftness", 2.5F);
        BuiltRectangle.safeSetUniform(shaderprogram, "EdgeSoftness", this.axN);
        BuiltRectangle.safeSetUniform(shaderprogram, "DitherStrength", this.QI);
        BuiltRectangle.safeSetUniform(shaderprogram, "Margin", this.avf);
        BuiltRectangle.safeSetUniform(shaderprogram, "NoiseStrength", 1.5F);
        BuiltRectangle.safeSetUniform(shaderprogram, "GlobalAlpha", f3);
        String s = "Стандарт";
        ...
        BuiltRectangle.safeSetUniform(shaderprogram, "GradientColor1", zY[0], zY[1], zY[2], zY[3] * f3);
        BuiltRectangle.safeSetUniform(shaderprogram, "GradientColor2", cu[0], cu[1], cu[2], cu[3] * f3);
        BuiltRectangle.safeSetUniform(shaderprogram, "GradientColor3", rM[0], rM[1], rM[2], rM[3] * f3);
        BuiltRectangle.safeSetUniform(shaderprogram, "GradientColor4", RN[0], RN[1], RN[2], RN[3] * f3);
        BuiltRectangle.safeSetUniform(shaderprogram, "BorderColor", oI[0], oI[1], oI[2]);
