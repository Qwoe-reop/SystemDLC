...
public class TPSTracker {
    ...
    private final ArrayDeque<Float> tpsSamples = new ArrayDeque<>(20);
    ...
    public float getTps() {
        return round(MathUtil.h(this.currentTps, 0.0F, 20.0F));
    }
    ...
    public long adjustForTps(long i) {
        return i <= 0L ? 0L : Math.max(1L, Math.round((float)i * this.getTickMultiplier()));
    }
    ...
    public int getPing() {
        if (MinecraftClient.method_1551().method_1562() != null && MinecraftClient.method_1551().field_1724 != null) {
            PlayerListEntry playerlistentry = MinecraftClient.method_1551().method_1562().method_2871(MinecraftClient.method_1551().field_1724.method_5667());
