...
public class KeyBindSetting extends Setting {
    ...
    public KeyBindSetting(String s, String s1, int i) {
        super(s, s1);
        this.defaultKeyCode = i;
        this.keyCode = i;
        this.modifierFlags = 0;
        this.keyName = this.formatKeyName(i, 0);
    }

    public KeyBindSetting(String s, String s1, int i, Runnable runnable) {
        this(s, s1, i);
    ...
    public void setKeyAndModifiers(int i, int j) {
        ...
        this.keyName = this.formatKeyName(i, j);
    }
    ...
    public static boolean isModifierKey(int i) {
        return i == 340 || i == 344 || i == 341 || i == 345 || i == 342 || i == 346;
    }

    public static int getModifierFlag(int i) {
        switch (i) {
            case 340:
            case 344:
                return 1;
    ...
    public String formatKeyName(int i, int j) {
        return formatKeyNameStatic(i, j);
    }

    public static String formatKeyNameStatic(int i, int j) {
        if (i == -1) {
            return "None";
        }
        ...
        stringbuilder.append(getKeyNameStatic(i));
        return stringbuilder.toString();
    }

    public static String getKeyNameStatic(int i) {
        if (i == -1) {
            return "None";
        }
    ...
    public boolean isPressed() {
        ...
        return i == 0L ? false : GLFW.glfwGetKey(i, this.keyCode) == 1;
    }
