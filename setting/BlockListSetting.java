...
public class BlockListSetting extends Setting {
    private static final String[] aiK = new String[]{"name", "enabled", "blue", "red", "id", "alpha", "type", "blocks", "green"};
    private final Map<Block, BlockEntry> blocks = new ConcurrentHashMap<>();
    private final Map<Block, BlockEntry> defaultBlocks = new HashMap<>();
    ...
    public JsonObject toJson() {
        ...
        for (Entry entry : this.blocks.entrySet()) {
            ...
            Identifier identifier = Registries.field_41175.method_10221((Block)entry.getKey());
    ...
    public void fromJson(JsonObject jsonobject) {
        if (jsonobject.has(aiK[7])) {
            ...
            for (int i = 0; i < jsonarray.size(); i++) {
                ...
                Identifier identifier = Identifier.method_60654(s);
                Block block = (Block)Registries.field_41175.method_63535(identifier);
                if (block != null) {
