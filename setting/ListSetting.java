...
public class ListSetting extends Setting {
    ...
    public ListSetting(String s, String s1, List<String> list, List<String> list1, boolean flag, int i, int j) {
        ...
        if (list != null && !list.isEmpty()) {
            this.availableValues = new ArrayList<>(list);
            this.defaultValues = new ArrayList<>(list1 != null ? list1 : new ArrayList<>());
            this.selectedValues = new ArrayList<>(this.defaultValues);
    ...
    public void setSelectedValues(List<String> list) {
        ...
        if (list == null) {
            ...
            this.selectedValues = new ArrayList<>(list);
        }
    ...
    public void fromJson(JsonObject jsonobject) {
        ...
        if (jsonobject.has("selectedValues")) {
            ...
            ArrayList arraylist1 = new ArrayList<>(this.selectedValues);
    ...
    @Override
    public void reset() {
        this.setSelectedValues(new ArrayList<>(this.defaultValues));
    }
